...
{
    add_meta_box('lsdc_product_data', __('Data Produk', 'lsdcommerce') , 'lsdc_product_data', 'lsdc-product', 'normal', 'high');
}
...
function lsdc_metabox_save($post_id)
{
    ...
    if (!isset($_POST['lsdc_admin_nonce']) || !wp_verify_nonce($_POST['lsdc_admin_nonce'], basename(__FILE__))) return 'Nonce not Verified';
    ...
    if ('lsdc-product' == $_POST['post_type'])
    { // Check Permission
